...
public class DataInitializerEngage implements Runnable {
	private long marktime;
	private SimpleDateFormat DATE_FORMAT = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");

	public DataInitializerEngage() {
	...
	public static void main(final String[] args) {
		TestRunnerUtil.runAsDominoThread(new DataInitializerEngage(), TestRunnerUtil.NATIVE_SESSION);
	}
